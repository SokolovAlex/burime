...
const collections =  {
    ...
    [WordType.ready]: ['а вы могли бы?', 'я вас любил...', 'смеятся над собой', 'в городском саду', '3/4', 'шорох мозга', 'топот интеллекталов', 'что такое осень?', 'весь мир театр', 'все связано', 'я памятник себе воздвиг'],
}
